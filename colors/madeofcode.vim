" Vim color file
" Converted from Textmate theme Made of Code using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=16 ctermbg=51 cterm=NONE guifg=#090a1b guibg=#00ffff gui=NONE
...
hi MatchParen ctermfg=203 ctermbg=NONE cterm=underline guifg=#ff3854 guibg=NONE gui=underline
...
hi IncSearch ctermfg=16 ctermbg=119 cterm=NONE guifg=#090a1b guibg=#8fff58 gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#f8f8f8 guibg=#407d0a gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#850205 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=17 cterm=NONE guifg=#f8f8f8 guibg=#142a51 gui=NONE
